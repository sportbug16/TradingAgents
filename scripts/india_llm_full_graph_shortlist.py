"""Run TradingAgentsGraph only on shortlisted Indian screen results."""
...
from tradingagents.india.shortlist import load_screen_results, select_shortlist
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", default="reports/india_full_graph_shortlist/default.json")
    ...
    config.update(
        {
            ...
            "memory_log_path": f"reports/india_full_graph_memory_{provider}.md",
            "results_dir": f"reports/india_full_graph_results/{provider}",
            "data_cache_dir": f"reports/india_full_graph_cache/{provider}",
        }
    )
